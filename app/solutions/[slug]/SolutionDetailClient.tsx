      ...
      <main>
        ...
        {solution.approach.length > 0 && (
          ...
          <section className="py-16 md:py-24 bg-background">
            <div className="container mx-auto px-4 md:px-6">
              <motion.div className="max-w-2xl mx-auto text-center mb-16" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                <span className="inline-block px-4 py-2 mb-6 text-sm font-medium text-foreground bg-primary/10 rounded-full border border-primary/20">Our Approach</span>
              ...
              <div className="bg-surface-card rounded-3xl border border-border px-8 py-16 md:px-16 md:py-20">
                  <div className="flex flex-col items-center text-center">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground leading-tight mb-6">
                      Ready to Start Your{' '}
                      <span className="text-foreground">{solution.title}</span>{' '}Journey?
                    </h2>
                    ...
                    <Link href="/solutions" className="mt-6 inline-flex items-center gap-2 text-muted hover:text-foreground transition-colors">
